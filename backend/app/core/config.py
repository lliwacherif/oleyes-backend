...
SUPREME_FRAME_INTERVAL = float(get_env("SUPREME_FRAME_INTERVAL", "0.5"))
...
SUPREME_COOLDOWN = float(get_env("SUPREME_COOLDOWN", "3.0"))
SUPREME_CROP_MAX_DIM = int(get_env("SUPREME_CROP_MAX_DIM", "512"))
